function renderTheme() {
    ...
    <section class="py-20 bg-[#2C4A3B] text-[#FAF8F5] overflow-hidden relative">
        <div class="absolute top-0 left-0 w-full h-full opacity-5 parallax-slow" style="background-image: radial-gradient(circle, #F4A261 1px, transparent 1px); background-size: 32px 32px;"></div>
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center gsap-fade-up gsap-hide">
            <h2 class="font-heading text-5xl md:text-7xl font-extrabold mb-8 gradient-text tracking-tighter">Home</h2>
